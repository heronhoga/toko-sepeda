...
<html lang="en">
  <head>
    ...
    <style>
        ...
        margin: auto; /* Center the table on the screen */
        margin-top: 20px; /* Add top margin if needed */
        margin-bottom: 100px; /* Add bottom margin if needed */
    }
    </style>
  </head>
  <body>
...
<!--NAV-->
  ...
  <a class="navbar-brand" href="#">{{ session('user_data')->nama_supervisor }}</a>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <div id="headerpenjualan">
        <h1 id="headerpenjualantext">Overview penjualan sepeda</h1>
    </div>
